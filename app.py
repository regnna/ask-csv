...
def main():
  ...
  st.markdown("<h5 style='text-align: center; color: black;'> Get Your openai API key<a href='https://platform.openai.com/account/api-keys' target='_blank'> here</a></h2>",unsafe_allow_html=True)
